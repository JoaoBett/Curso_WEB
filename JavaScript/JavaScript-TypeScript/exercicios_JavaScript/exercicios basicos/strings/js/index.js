...
document.body.innerHTML += `Qual o primeiro indice da letra a no seu nome? ${nome.indexOf('a')+1} <br />`
document.body.innerHTML += `Qual o ultimo indice da letra a no seu nome? ${nome.lastIndexOf('a')+1} <br />`
